<nav class="navbar navbar-expand-sm navbar-dark bg-teal-light text-teal-dark">
    ...
    <a class="navbar-brand fs-4 ms-2 text-teal-dark fw-bolder" href="">
    {{Auth()->user()->library}}
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto me-3">
          <li class="nav-item">
            <a class="nav-link text-teal-dark" href="{{route('dashboard')}}">Home</a>
          </li>
            <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu me-auto" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item text-teal-dark" href="{{route('profile.password')}}">Change Password</a></li>
                  <li><a class="dropdown-item text-teal-dark" href="{{route('profile.delete')}}">Delete Account</a></li>
                </ul>
              </li>
              <li class="nav-item">
